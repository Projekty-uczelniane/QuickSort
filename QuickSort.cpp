...
int main()
{
    ...
    do
    {
        ...
        while(!(cin>>wybor))
        {
            cout<<"B³êdne dane.Spróbuj jeszcze raz";
            cin.clear();
            cin.ignore(1000,'\n');
        }
        ...
        {
            system("cls");
            cout<<"-------------------------------------------Wybór wype³nienia tablicy-------------------------------------------"<<endl;
            cout<<"1-Losowa tablica"<<endl;
            cout<<"2-Posortowana tablica"<<endl;
            cout<<"3-Du¿a liczba duplikatów w tablicy"<<endl;
            ...
            case 3:
            {
                Plik<<"Du¿a liczba duplikatów w tablicy"<<std::endl;
                break;
            }
            ...
            cout<<"Testy zakoñczone. Wyniki mo¿na znaleŸæ w dane1.csv"<<endl;
            Sleep(2500);
        }
        while(wybor1!=0);
    }
